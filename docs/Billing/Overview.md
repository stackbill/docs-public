...
## Billing System in CloudPortal (Cloud Management Portal)
...
**CloudPortal** is a **usage-based billing** and chargeback solution that supports both **postpaid and prepaid billing**. It is also possible to **generate the bill amount** in your **regional currency**.


### Billing Overview in CloudPortal CMP
...
<img src="/help/img/Billing/1billingoverview-CloudPortalcloudmanagementportal.png" width="90%" />

- The **Billing overview** screen appears.

<img src="/help/img/Billing/2billingoverview-CloudPortalcloudmanagementportal.png" width="90%" />
...
<img src="/help/img/Billing/3billingoverview-CloudPortalcloudmanagementportal.png" width="90%" />
...
<img src="/help/img/Billing/4billingoverview-CloudPortalcloudmanagementportal.png" width="80%" />

-  **The Budget alert** can be set by clicking the **Setup alert** option in the menu. 

<img src="/help/img/Billing/5billingoverview-CloudPortalcloudmanagementportal.png" width="70%" />
